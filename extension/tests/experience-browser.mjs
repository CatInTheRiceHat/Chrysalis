...
try {
 ...
 await expect(popup.locator('#time-target')).toHaveValue('none');
 ...
 await popup.locator('#time-target').selectOption('none');
 ...
 checks.push('Session preferences fill new plans and break controls; long custom intention/no target works; edit cancellation restores focus.');
