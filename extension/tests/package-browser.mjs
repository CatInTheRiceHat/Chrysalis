...
const suites = ['startup-browser', 'integrated-browser', 'browser', 'session-browser', 'viewing-browser', 'experience-browser', 'checkpoints-browser', 'history-browser', 'hardening-browser', 'usability-browser', 'usability-native', 'encrypted-history-browser'];
