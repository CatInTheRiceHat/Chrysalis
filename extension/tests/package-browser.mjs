...
const suites = ['browser', 'session-browser', 'viewing-browser', 'experience-browser', 'checkpoints-browser', 'history-browser', 'hardening-browser'];
...
console.log('All seven suites passed against the extracted distribution ZIP.');
