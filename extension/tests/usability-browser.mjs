...
try {
 ...
 if(!before){await expect(popup.locator('#session-target')).toContainText('15 minutes');await expect(indicator.locator('#phase')).toBeVisible();await expect(indicator.locator('#phase')).toHaveText('Paused by you');}
